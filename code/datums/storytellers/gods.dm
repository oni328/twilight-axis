...
/datum/storyteller/astrata
	...
	desc = "Бандиты, личи, оборотни и вампирские лорды не выпадают. Маскарад - единственный основной антагонист на старте раунда и получает вес x1.5. Гноллы отключены. wretches масштабируются обычным образом."
...
/datum/storyteller/eora
	name = "Eora"
	ru_name = "Эора"
	vote_desc = "Воцаряется любовь. Добрые события приходят чаще, и Она не желает никому зла. Без антагонистов и гноллов; лишь горстка wretches прячется на окраинах. Её милость обращена к романтике."
	desc = "Массовые события получают вес x1.5, благословения - x1.2. Без антагонистов и набегов. Божественное вмешательство случается в 2 раза чаще, личные события - в 1.4 раза чаще. wretches жёстко ограничены 5-ю слотами. Гноллы отключены."
...
/datum/storyteller/baotha
	...
	desc = "События безумия, магии и бедствий получают повышенный вес (от x1.1 до x1.4). Вампирский лорд гарантирован на старте раунда; бандиты, личи и оборотни не выпадают. Все события накапливают очки быстрее. Режим гноллов выбирается случайно. Может сработать расширение количества слотов wretches в зависимости от количества слотов гарнизона."
